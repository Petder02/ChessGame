 ...
 * 
 * @author Harold Connamacher (enum Side, legalPieceToPlay(ChessPiece piece, int row, int column), makeMove(ChessPiece piece, int toRow, int toColumn))
 * @author Peter Schlueter (getNumRows(), getNumColumns(), startGame(Chessboard board))
 * 
 */
public interface ChessGame {
  ...
  /**
   * Gets the number of rows in a board for this type of chess game
   * @return the number of rows in a board for this type of chess game
   */
  public int getNumRows();
  
  /**
   * Gets the number of columns in a board for this type of chess game
   * @return the number of columns in a board for this type of chess game
   */
  public int getNumColumns();
  
  /**
   * Starts the chess game of the board type that is inputted
   * @param board  the board whose game rules are used for this game
   */
